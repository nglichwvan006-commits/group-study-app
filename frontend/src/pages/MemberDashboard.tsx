...
import { BookOpen, MessageSquare, LogOut, Send, CheckCircle, FileText, Sun, Moon, Menu, X, Clock, Trophy, Bell, Sparkles, ChevronRight } from 'lucide-react';
        ...
        <div className="p-4 sm:p-10 max-w-7xl mx-auto flex flex-col h-full min-h-screen">
          <AnimatePresence mode="wait">
            <motion.div key={activeTab} initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} transition={{ duration: 0.3, ease: 'circOut' }} className="flex-1 flex flex-col">
              ...
              {activeTab === 'chat' && <div className="flex-1 bg-white/80 dark:bg-slate-900/80 backdrop-blur-3xl rounded-[2.5rem] shadow-2xl border border-white/20 dark:border-slate-800/50 overflow-hidden flex flex-col min-h-[600px] mb-6"><Chat /></div>}
